...
const newPokemonReducer = createReducer(
  initialState,
  on(PokemonAction.loadPokemonMini, (state, action) => ({
    ...state,
    loading: true
  })),
  on(PokemonAction.loadMiniSuccess, (state, action) => ({
    ...state,
    loading: false,
    miniPokemons: action.data
  })),
  on(PokemonAction.loadMiniFailure, (state, uid) => state),
  on(PokemonAction.loadPokemon, (state, action) => ({
    ...state,
    loading: true
  })),
  ...
  on(PokemonAction.loadFavorites, (state, action) => ({
    ...state,
    loading: true
  })),
  on(PokemonAction.loadFavoritesSuccess, (state, action) => ({
    ...state,
    loading: false,
